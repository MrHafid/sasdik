...
t=ambilno.substring(0,4);
   ...
   //bukannomor=true;
    while(b<a){
        if(telkomsel[b]==t){
            $('.no_hp').css({"background-image":"url(gambar/telkomsel.png)"});
    ...
    b=0;
     while(b<a&&kondisi){
        if(indosat[b]==t){
             $('.no_hp').css({"background-image":"url(gambar/indosat.png)"});//menampilkan logo operator
            kondisi=false;
            }++b;
    }
    ...
    b=0;
     while(b<a&&kondisi){
        if(three[b]==t){
             $('.no_hp').css({"background-image":"url(gambar/three.png)"});
            kondisi=false;
            }++b;
    }
      a=smartfren.length;
    b=0;
     while(b<a&&kondisi){
        if(smartfren[b]==t){
             $('.no_hp').css({"background-image":"url(gambar/smartfren.png)"});
            kondisi=false;
            }++b;
    }
    a=xl.length;
    b=0;
     while(b<a&&kondisi){
        if(xl[b]==t){
             $('.no_hp').css({"background-image":"url(gambar/xl.png)"});
            kondisi=false;
            }++b;
    }
      a=axis.length;
    b=0;
     while(b<a&&kondisi){
        if(axis[b]==t){
             $('.no_hp').css({"background-image":"url(gambar/axis.png)"});
            kondisi=false;
            }++b;
    }
...
function gambaroperatorhilang(){ 
    $('.no_hp').css({"background-image":"url()"});
}
